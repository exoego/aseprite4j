...
public final class UserDataChunk implements FrameChunk {
    ...
    static UserDataChunk build(InputStreamReader reader) throws IOException {
        ...
        if ((flags & 0x4) != 0) {
            ...
            var numberOfProperties = (int) reader.DWORD();
            ...
            for (int i = 0; i < numberOfProperties; i++) {
                ...
                switch (propertyType) {
                    ...
                    default -> throw new UnsupportedOperationException("Unknown property type: " + propertyType);
                }
            }
        }
